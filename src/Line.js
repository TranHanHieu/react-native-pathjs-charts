...
import Svg, { G, Path, Rect, Text, Circle, Line, Ellipse } from 'react-native-svg';
...
export default class LineChart extends Component {
  ...
  render() {
    ...
    >
        ...
        <Text x={this.state.curPosX - 7.5} y={this.state.chartStartY - 34}  fill={'white'} fontSize={14}>{this.props.convert(String(Math.floor(this.curPos * (this.props.data[0].length - 1))))}</Text>
